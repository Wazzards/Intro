...
<kbd> conflict </kbd> <kbd> replace </kbd> <kbd> name </kbd> <kbd> description </kbd> <kbd> maintainer </kbd>  
<kbd> author </kbd> <kbd> license </kbd> <kbd> icon </kbd> <kbd> content </kbd> <kbd> pythonmin </kbd> <kbd> file </kbd>  
<kbd> preferencepack </kbd> <kbd> subdirectory </kbd> <kbd> classname </kbd> <kbd> macro </kbd>  
<kbd> freecadmin </kbd> <kbd> freecadmax </kbd> <kbd> version </kbd> <kbd> date </kbd> <kbd> depend </kbd>  
<kbd> tag </kbd> <kbd> other </kbd> <kbd> workbench </kbd> <kbd> bundle </kbd> 
